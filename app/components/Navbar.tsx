...
import { ListTree, Menu, PackagePlus, ShoppingBasket, Warehouse, X  ,  Receipt , LayoutDashboard, ArrowBigRightDash} from 'lucide-react'
...
const Navbar = () => {
    ...
    const navLinks = [
        ...
        { href: "/exit", label: "Sortie", icon: ArrowBigRightDash },
